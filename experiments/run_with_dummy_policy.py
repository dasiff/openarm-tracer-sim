"""Run simulation with dummy policy - capture visual snapshots.
...
def run_simulation():
    ...
    sim = RobotSimulator(
        ...
        track_bodies=["block"],  # this scene's object of interest
    )
    ...
    with mujoco.viewer.launch_passive(sim.model, sim.data) as viewer:
        ...
        initial_block = sim.get_body_state("block")["position"]
        ...
        while viewer.is_running() and t < duration:
            ...
            if step % 250 == 0:
                block_pos = sim.get_body_state("block")["position"]
        ...
        final_block = sim.get_body_state("block")["position"]
